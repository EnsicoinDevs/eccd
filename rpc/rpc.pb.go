...
func (m *GetBlockHashAtHeightRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetBlockHashAtHeightRequest.Merge(m, src)
}
...
func (m *GetBlockHashAtHeightReply) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetBlockHashAtHeightReply.Merge(m, src)
}
...
func (m *GetBlockByHashReply) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetBlockByHashReply.Merge(m, src)
}
...
func (m *GetMainChainHeightRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetMainChainHeightRequest.Merge(m, src)
}
...
func (m *GetMainChainHeightReply) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetMainChainHeightReply.Merge(m, src)
}
...
func (m *GetMainChainRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetMainChainRequest.Merge(m, src)
}
...
func (m *GetMainChainReply) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetMainChainReply.Merge(m, src)
}
